...
import { Preferences, PreferencesTextWeight } from '../../store/types';
            ...
            <div css={cssContentContainer}>
                ...
                <div css={cssControlsContainer}>
                    ...
                    <DropdownSelect
                        ...
                        onChange={({ target: { value }}) => setPrefs((curr) => ({...curr!, textPrimary: { ...curr!.textPrimary, weight: (value as PreferencesTextWeight) }}))}
                        label='Text Weight'
                    >
