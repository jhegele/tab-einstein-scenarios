...
const slicePreferences = createSlice({
  ...
  reducers: {
    ...
    preferencesUpdateGlobal: (
      state,
      action: PayloadAction<PreferencesGlobal>
    ) => {
    ...
    preferencesUpdatePredict: (
      state,
      action: PayloadAction<PreferencesPredict>
    ) => {
    ...
    preferencesUpdateExplain: (
      state,
      action: PayloadAction<PreferencesExplain>
    ) => {
    ...
    preferencesUpdateAction: (
      state,
      action: PayloadAction<PreferencesAction>
    ) => {
